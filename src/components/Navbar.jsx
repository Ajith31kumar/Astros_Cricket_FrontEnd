...
function Navbar() {
  ...
  // Desktop links animation variants
  const navVariants = {
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="h-16 lg:h-20 flex items-center justify-between">
          ...
          >
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#facc15] to-[#a16207] flex items-center justify-center font-bold text-white text-lg shadow-[0_0_15px_rgba(250,204,21,0.4)] group-hover:scale-110 transition-transform duration-300">
              A
            </div>
